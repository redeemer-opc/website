...
function et_builder_load_modules_styles() {
	...
	wp_register_script( 'google-maps-api', esc_url( add_query_arg( array( 'key' => 'AIzaSyBza1z7AVDcYFKdSDHSCyaTGbtcRqsq2mE' ), is_ssl() ? 'https://maps-api-ssl.google.com/maps/api/js' : 'http://maps.google.com/maps/api/js' ) ), array(), ET_BUILDER_VERSION, true );

...
function et_pb_add_builder_page_js_css(){
	...
	wp_enqueue_script( 'google-maps-api', esc_url( add_query_arg( array( 'key' => 'AIzaSyBza1z7AVDcYFKdSDHSCyaTGbtcRqsq2mE' ), is_ssl() ? 'https://maps-api-ssl.google.com/maps/api/js' : 'http://maps.google.com/maps/api/js' ) ), array(), '3', true );
